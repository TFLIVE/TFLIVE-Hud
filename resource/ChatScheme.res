Scheme
{
	Colors
	{
	    ...
	    "TFVioletBright"            "178 102 255 255" //
	...
	BaseSettings
	{
		...
		Menu.ArmedBgColor								"TFVioletBright"
		Menu.TextInset									"6"
		Panel.FgColor									"Blank"
		...
		RichText.SelectedBgColor						"TFVioletBright"
		ScrollBar.Wide									"0"
		...
		TextEntry.SelectedBgColor						"TFVioletBright"
		TextEntry.OutOfFocusSelectedBgColor				"255 155 0 128"
		TextEntry.FocusEdgeColor						"0 0 0 196"
		ToggleButton.SelectedTextColor					"TFVioletBright"
		Tooltip.TextColor								"0 0 0 196"
		Tooltip.BgColor									"TFVioletBright"
